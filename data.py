...
class Time:
    ...
    def __eq__(self, other:any) -> bool:
        if isinstance(other, Time):
            #return (other == type(Time) and
            #    self.hour == type(int) and
            #    self.minute == type(int) and
            #    self.second == type(int))
    ...
    def __repr__(self) -> str:
        return '{} hour(s), {} minute(s), {} second(s)'.format(self.hour, self.minute, self.second)
